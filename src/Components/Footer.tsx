...
const Footer: FC<Props> = () => {
  return (
    <>
      ...
      <a className="text-center text-blueGray-600 hover:text-blueGray-800 cursor-pointer transition-colors duration-300 ease-in-out" href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" rel="noopener noreferrer"><span className="hidden lg:inline-block">CC BY-NC-SA 4.0 2021</span> &copy; Nick Graffis.</a>
      <div className="flex items-center space-x-4">
        <svg fill="currentColor" className="lg:h-6 lg:w-6 h-4 w-4 text-blueGray-600 transition-colors duration-300 ease-in-out cursor-pointer hover:text-blueGray-800" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
